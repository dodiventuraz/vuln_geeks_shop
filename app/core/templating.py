...
Autoescape Jinja2 AKTIF (default) — ini jalur AMAN P1. Titik XSS/SSTI (Web-A03-b/Web-A03-c)
...
# Dipakai template untuk bercabang rentan/aman (mis. Web-A03-b XSS `| safe`).
